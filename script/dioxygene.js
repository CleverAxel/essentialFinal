...
const NOM_PRODUIT = "The O²";
const LISTE_PRODUIT = "produit";
const PRIX_PRODUIT = 0.05;
const NOM_IMAGE = "dioxygene.png";
let indice = 0;
...
if(localStorage.getItem(LISTE_PRODUIT, listePanier) != null){
    ...
    //Je récupère ici l'indice où est stocké le produit s'il existe déjà, si non, il va être créé plus bas
    ...
    /*while(listePanier[indice].nom != NOM_PRODUIT && indexedDB < listePanier.length){
        indice++;
    }*/
}
updateNotification();
